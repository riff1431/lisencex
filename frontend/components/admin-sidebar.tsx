...
const adminLinks = [
  ...
  { href: '/admin/orders', label: 'Orders & Sales', icon: Receipt },
  { href: '/admin/payments', label: 'Payments & Gateway', icon: CreditCard },
  { href: '/admin/refunds', label: 'Refunds & Reversals', icon: RotateCcw },
  { href: '/admin/customers', label: 'Customers & Users', icon: Users },
  { href: '/admin/purchases', label: 'Purchases & Claims', icon: ShoppingBag },
  { href: '/admin/licenses', label: 'Licenses Manager', icon: KeyRound },
  { href: '/admin/activations', label: 'Live Activations', icon: Laptop2 },
  { href: '/admin/recoveries', label: 'License Recoveries', icon: RotateCcw },
  { href: '/admin/security', label: 'Security & Blocklist', icon: ShieldAlert },
  { href: '/admin/emergency', label: 'Emergency & Kill-Switch', icon: Flame },
